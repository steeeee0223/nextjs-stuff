...
export const ActionCell = ({ id, type }: ActionCellProps) => {
  const onConnect = () =>
    console.log(`[connection] setup connection to ${type}`);
  const onDisconnect = () => console.log(`[connection] disconnect ${id}`);
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuItem variant="warning" onClick={onDisconnect}>
          Disconnect account
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
